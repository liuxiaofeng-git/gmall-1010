...
public class SpuController {
    ...
    public ResponseVo<PageResultVo> querySpusPageByCategoryId(PageParamVo pageParamVo,@PathVariable("categoryId")Long categoryId){
        PageResultVo spus=spuService.querySpusPageByCategoryId(pageParamVo,categoryId);
        return ResponseVo.ok(spus);
    }
    /**
     * 列表
     */
    ...
    public ResponseVo update(@RequestBody SpuEntity spu){
        ...
        this.rabbitTemplate.convertAndSend("pms.item.exchange","cart.update",spu.getId());
        return ResponseVo.ok();
    }
